...
from python文件.profile_test import profile_widget
from python文件.first_page import first_page
from python文件.refistered import second_page_widget
from python文件.hot_healthy_probelem import fifth_page_widget
from python文件.select_from_hot import chosePMD_from_HHP_widget
from python文件.select_from_all import chosePMD_from_AP_widget
from python文件.select_from_all_2 import chosePMD_from_AP_widget_2
from python文件.sign_doctor import PMD_detail_widget
from python文件.pay import pay
from python文件.pay2 import pay_2
from python文件.new_patient import new_patient
from python文件.pro_sys import expert_sys_widget
from python文件.com import conmunication_widget
from python文件.select_from_host_2 import chosePMD_from_HHP_widget_2
from python文件.my_record import my_record
