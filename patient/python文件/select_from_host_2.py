...
import pymysql
class chosePMD_from_HHP_widget_2(QWidget):
    ...
    def setupUI(self):
        ...
        db = pymysql.connect("localhost", "root",
                             "caoqiming6666", "hospital_management", charset='utf8')
        # 使用cursor()方法获取操作游标
        cursor = db.cursor()
        self.setGeometry(QtCore.QRect(259, 29, 981, 671))
        self.setObjectName("widget")
        self.ComRan_comboBox_2 = QtWidgets.QComboBox(self)
        self.ComRan_comboBox_2.setGeometry(QtCore.QRect(20, 20, 201, 26))
        self.ComRan_comboBox_2.setObjectName("ComRan_comboBox_2")
        self.ComRan_comboBox_2.addItem("综合排序")
        self.ComRan_comboBox_2.addItem("满意度排序")
        self.area_comboBox_2 = QtWidgets.QComboBox(self)
        self.area_comboBox_2.setGeometry(QtCore.QRect(270, 20, 201, 26))
        self.area_comboBox_2.setObjectName("area_comboBox_2")
        self.area_comboBox_2.addItem("中山区")  # 地区排序
        self.area_comboBox_2.addItem("金州区")
        self.area_comboBox_2.addItem("西岗区")
