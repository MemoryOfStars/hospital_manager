...
from python文件.login_gerneral import Ui_Dialog
from python文件.general import Ui_Form
from python文件.mysql import conn_mysql
from python文件.HHP_scrollarea_widget import HHP_scrollarea_widget
...
from UI文件.账户密码错误 import model_dialog_show_str
